...
An interactive Power BI dashboard analyzing country-wise agricultural production, productivity, and area utilization across 12 nations (2009–11) | Data Source: data.gov.in

<div align="center">

<!-- Header Banner -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=2c6e49&height=200&section=header&text=Agricultural%20Dashboard&fontSize=52&fontColor=ffffff&fontAlignY=38&desc=A%20Country-Wise%20Analysis%20of%20Production,%20Productivity%20%26%20Area&descAlignY=58&descSize=18&descColor=c8e6c9"/>
...
![License](https://img.shields.io/badge/License-MIT-4c956c?style=for-the-badge)

<br/>

[![GitHub](https://img.shields.io/badge/GitHub-BabithaRavindra-181717?style=flat-square&logo=github)](https://github.com/BabithaRavindra)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-babitha--ravindra-0A66C2?style=flat-square&logo=linkedin)](https://linkedin.com/in/babitha-ravindra)
...
| ⚖️ Productivity Assessment | Measure output efficiency per unit of land |
...
![Agricultural Dashboard](Dashboard.png)
...
- 🗺️ **Geospatial Map** — Country-wise area of production
...
> ⚠️ **Data Quality Note:** Missing values existed for Iran and Turkey in 2010 (fruits & vegetables respectively). These records were removed during the data cleaning phase to ensure analytical accuracy.
...
| # | Insight |
|---|---------|
| 🥇 | **China leads** in total production volume, followed by India and Brazil |
| 📈 | Overall production shows a **positive growth trend** from 2009–10 to 2010–11 |
| 🌿 | **Vegetables dominate** the product-wise production split globally |
| ⚡ | **Indonesia and Philippines** show high productivity relative to land used |
| 🌍 | **Others (aggregated)** category holds the largest land area under production |
| 🔮 | Forecasts project **China and India** will maintain production dominance through 2030 |
| ⚠️ | Significant **productivity gap** exists between high- and low-performing countries |
...
├── 📊  Acricultural_Dashboard.pbix       # Power BI Dashboard file
├── 📂  Agricutural_Dataset.xls           # Excel workbook (Original, Transformed & Cleaned sheets)
├── 📄  Aricultural_Data_Analysis_Report.pdf  # Full project analysis report
